        ...
        for triplet in self.tripleListTest:
            ...
            for i in nameRank:
                if i[0] == triplet[2]:
                    break
                x += 1
            self.rank.append((triplet, triplet[2], nameRank[0][0], x, (1-x/len(nameRank))*math.sin(nameRank[0][1]*math.pi/(2*nameRank[x-1][1]))))
            print(x)
            cou += 1
            if cou % 10000 == 0:
                print(cou)
...
if __name__ == '__main__':
    ...
    dirTest = "/Users/yfli/Desktop/实验品/demo/algorithm/test.txt"
    ...
    # testHeadRaw.writeRank(path+"/test/testHeadRaw" + ".txt")
    testHeadRaw.getRelationRank()
    print(testHeadRaw.getMeanRank())
    testHeadRaw.writeRank("/Users/yfli/Desktop/实验品/demo/algorithm/test/testRelationRaw.txt")
    ...
    # testTailRaw.writeRank(path+"/test/testTailRaw" + ".txt")
    #
    ...
    # testHeadFit.writeRank(path+"/test/testHeadFit" + ".txt")
    # testHeadFit.getRelationRank()
    # print(testHeadFit.getMeanRank())
    # testHeadFit.writeRank(path+"/test/testRelationFit" + ".txt")
    #
    ...
    # testTailFit.writeRank(path+"/test/testTailFit" + ".txt")