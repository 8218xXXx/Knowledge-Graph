...
class Weibo:
    cookie = {
        #"Cookie": 'webim_unReadCount=%7B%22time%22%3A1570256235794%2C%22dm_pub_total%22%3A0%2C%22chat_group_client%22%3A0%2C%22allcountNum%22%3A0%2C%22msgbox%22%3A0%7D; wb_view_log_5934057418=1680*10502; YF-Page-G0=aac25801fada32565f5c5e59c7bd227b|1570256143|1570256143; wvr=6; ALF=1601792140; SSOLoginState=1570256141; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9Whi3D.UuLNFR5rpijpEO01J5JpX5KzhUgL.Fo-4e0B7SKMXeKn2dJLoI0qLxK-L1K-L122LxK-LBoeLBo5LxK-LBoeLBo5LxKML1KqLB-qLxKML1KqLB-qLxKML1KqLB-qt; SUHB=0wnltC0ZxulhYJ; wb_view_log=1680*10502; cross_origin_proto=SSL; login_sid_t=b5a70d6e66543e71c6d0fbc63747bc1c; Ugrow-G0=9ec894e3c5cc0435786b4ee8ec8a55cc; WBStorage=384d9091c43a87a5|undefined; YF-V5-G0=4e19e5a0c5563f06026c6591dbc8029f; Apache=3175032983460.6294.1570181597186; _s_tentry=passport.weibo.com; SINAGLOBAL=3175032983460.6294.1570181597186; ULV=1570181597191:1:1:1:3175032983460.6294.1570181597186:; UOR=,,baidu.com'
    ...
    def write_mysql(self):
        try:
            ...
            try:
                cursor.execute(
                    profile_2.format(self.username, self.user_id, img_url, authentication, hometown, birthday,
                                     introduction, label, gender, education))
                conn.commit()
            except:
                print("存入数据库失败")
                conn.rollback()
    ...
    def get_cc_live(self):
        try:
            url = "https://cc.163.com/522777"
            # url = "https://weibo.cn/mayun?filter=0&page=1"
            # html = requests.get(url, cookies=self.cookie).content
            html = requests.get(url).content
            selector = etree.HTML(html)
            # "div[@id='live_player']/div[@id='live-wrapper']/div[@id='comment-canvas']/@class"
            # 微博数
            page_num = selector.xpath("//div[@class='js-player-container player-container']/@style")
            page_num_2 = selector.xpath("//body/div[3]/div[2]/div[2]/div[2]/div[1]/div")[0]
            print(tostring(page_num_2))
            print(page_num)
...
def test():
    wb = Weibo('', filter)  # 调用Weibo类，创建微博实例wb
    wb.get_cc_live()
